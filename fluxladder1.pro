pro fluxladder1, date, alt_dir = alt_dir, altdirstr = altdirstr
...
flnma = '/unsafe/jsr2/'+date+'/'+altdirstr+'/29-Mar-14-Flux-Ladder-hmi-filter-'+altdirstr+'.eps'
flnmb = '/unsafe/jsr2/'+date+'/'+altdirstr+'/29-Mar-14-Flux-Ladder-Balm-HMI-Only-hmi-filter-'+altdirstr+'.eps'
endif else begin 
restore, '/unsafe/jsr2/'+date+'/29-Mar-2014-bk-subtracted-iris-hmi-area-energies-'+date+'.sav'
flnma = '/unsafe/jsr2/'+date+'/29-Mar-14-Flux-Ladder.eps'
flnmb = '/unsafe/jsr2/'+date+'/29-Mar-14-Flux-Ladder-Balm-HMI-Only.eps'
endelse
