pro hmi_process_filter, process = process, restore_sav = restore_sav, savf = savf, log = log
...
if keyword_set(log) then savff =  '/unsafe/jsr2/'+datstr+'/hmi_logsmth_diff.sav' else $
savff =  '/unsafe/jsr2/'+datstr+'/hmi_smth_diff.sav'
