...
loadct,0
xyouts, xyx, xyy, charsize = 0.3, 'IRIS SJ 1400 Coord: 4', /norm
...
;vert_line,sec,1, color = 2
loadct,0
xyouts, xyx, xyy, charsize = 0.3, 'IRIS SJ 2796 Coord: 4', /norm
...
;vert_line,sec,1, color = 2
loadct,0
xyouts, 2*xyx, xyy, charsize = 0.3, 'IRIS SG Balm Coord: 4', /norm
...
;vert_line,sec,1, color = 2
loadct,0
xyouts, xyx, xyy, charsize = 0.3, 'IRIS SJ 2832 Coord: 4', /norm
...
;vert_line,sec,1, color = 2
loadct,0
xyouts, xyx, xyy, charsize = 0.3, 'SDO HMI Coord: 4', /norm
device,/close
set_plot,'x'
