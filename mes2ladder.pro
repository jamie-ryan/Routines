...
mydevice=!d.name
set_plot,'ps'
device,filename=dir+'29-Mar-14-Quake-Area-Energy-Ladder.eps',/portrait,/encapsulated, decomposed=0,color = 1  , bits=8
o = 4
xyx = xpos[0] + 0.1*((xpos[1] - xpos[0])/2) ;middle of xrange
xyy = ypos[0,o] + ((ypos[1, o] - ypos[0, o])*0.85) ;y0 plus 90% of yrange
...
vert_line,sec,1, color = 2
loadct,0
xyouts, xyx, xyy, charsize = 0.7, 'IRIS SJ 1400 '+angstrom+' Coord: SQ', /norm
...
vert_line,sec,1, color = 2
loadct,0
xyouts, xyx, xyy, charsize = 0.7, 'IRIS SJ 2796 '+angstrom+' Coord: SQ', /norm
...
ytitl = energy
linecolors
utplot, tbalm[0, npix, *], balmerdata[0, 3, npix, *], $
timerange = '29-Mar-14 '+['17:26:00','17:55:00'], $
linestyle = 0, $
ycharsize = 0.55 , $
xcharsize = 0.65, $
...
vert_line,sec,1, color = 2
loadct,0
xyouts, xyx, xyy, charsize = 0.7, 'IRIS SG Balmer '+angstrom+' Coord: SQ', /norm
...
vert_line,sec,1, color = 2
loadct,0
xyouts, xyx, xyy, charsize = 0.7, 'IRIS SJ 2832 '+angstrom+' Coord: SQ', /norm
...
vert_line,sec,1, color = 2
loadct,0
xyouts, 0.92*xyx, xyy, charsize = 0.7, 'SDO HMI Continuum Coord: SQ', /norm
device,/close
set_plot,mydevice
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
for j = 0, frame-1 do begin
  for i = 0, npix-1 do begin
    ...
    if (j eq 1) then begin
      ...
      balm = string(balmerdata[j, 3, i, nmxbalm -7], format = '(E0.2)')
