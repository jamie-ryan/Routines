...
;-------
    ...
    flnm = '/unsafe/jsr2/'+date+'/29-Mar-14-Ribbon-Area-'+ii+'-Flux-Ladder.eps'
...
;ytitl = energy
linecolors
utplot, tsi[458:*], sidata[2, i, 458:*], /nodata, $ 
;base, $
...
outplot, tsi[458:*], sidata[2, i, 458:*], color = col
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
xyouts, xyx, xyy*0.98, charsize = 0.5, 'Si IV Coord: '+ii, /norm
xyouts, xyx, xyy*1.03, charsize = 0.5, 'Flux Curves From Coords '+xx+'",'+yy+'"', /norm
...
position = [xpos[0],ypos[0,o],xpos[1], ypos[1,o]], $
/NoErase
outplot, tmg[611:*], mgdata[2, i, 611:*], color = col
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
...
ytitl = flux
linecolors
utplot, times[i, 10:*], balmerdata[2, i, 10:*], $
/nodata, $
;    yrange = [mn, mx], $
/yst, $
timerange = '29-Mar-14 '+['17:30:00','17:53:00'], $
...
position = [xpos[0],ypos[0,o],xpos[1], ypos[1,o]], $
/NoErase
outplot, times[i, 10:*], balmerdata[2, i, 10:*], color = col
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
...
;ytitl = energy
linecolors        
utplot, tmgw[153:*], mgwdata[2, i, 153:*], $
/nodata, $
timerange = '29-Mar-14 '+['17:30:00','17:53:00'], $
linestyle = 0, $
ycharsize = 0.70 , $
...
position = [xpos[0],ypos[0,o],xpos[1], ypos[1,o]], $ 
/NoErase
outplot, tmgw[153:*], mgwdata[2, i, 153:*], color = col
;loadct,34
;vert_line,sec,1, color = 2
loadct,0
...
;ytitl = energy
linecolors
utplot, thmi[41:74], hmidata[2, i, 41:74], $
/nodata, $
timerange = '29-Mar-14 '+['17:30:00','17:53:00'], $
linestyle = 0, $
ycharsize = 0.70 , $
...
position = [xpos[0],ypos[0,o],xpos[1], ypos[1,o]], $
/NoErase
outplot, thmi[41:74], hmidata[2, i, 41:74], color = col
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
