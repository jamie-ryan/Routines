pro hmi_process_filter_universal_old, process = process, directory, submap_range = submap_range, phys_units = phys_units, dopp = dopp, restore_sav = restore_sav, savf = savf, log = log, difffilt = difffilt, bksub = bksub
