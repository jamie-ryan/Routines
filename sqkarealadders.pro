...
;-------
    ...
    flnm = '/unsafe/jsr2/'+date+'/29-Mar-14-Ribbon-Area-'+ii+'-Sunquake-Area-Power-Ladder.eps'
...
;ytitl = power
linecolors
utplot, tsi[458:*], sidata[3, i, 458:*]*A_sqk, /nodata, $ 
;base, $
...
outplot, tsi[458:*], sidata[3, i, 458:*]*A_sqk, color = col
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
xyouts, xyx, xyy*0.98, charsize = 0.5, 'Si IV Coord: '+ii, /norm
xyouts, xyx, xyy*1.03, charsize = 0.5, 'Power Radiated Over Sunquake Area (Central Coords '+xx+'",'+yy+'")', /norm
...
ytitl = power
linecolors
utplot, tmg[611:*], mgdata[3, i, 611:*]*A_sqk, $
/nodata, $
;timerange = '29-Mar-14 '+['17:30:00','17:53:00'], $
linestyle = 0, $
ycharsize = 0.70 , $
...
position = [xpos[0],ypos[0,o],xpos[1], ypos[1,o]], $
/NoErase
outplot, tmg[611:*], mgdata[3, i, 611:*]*A_sqk, color = col
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
...
ytitl = power
linecolors
utplot, times[i, 10:*], balmerdata[3, i, 10:*]*A_sqk, $
/nodata, $
;    yrange = [mn, mx], $
/yst, $
timerange = '29-Mar-14 '+['17:30:00','17:53:00'], $
...
position = [xpos[0],ypos[0,o],xpos[1], ypos[1,o]], $
/NoErase
outplot, times[i, 10:*], balmerdata[3, i, 10:*]*A_sqk, color = col
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
...
ytitl = power
linecolors        
utplot, tmgw[153:*], mgwdata[3, i, 153:*]*A_sqk, $
/nodata, $
timerange = '29-Mar-14 '+['17:30:00','17:53:00'], $
linestyle = 0, $
ycharsize = 0.70 , $
...
position = [xpos[0],ypos[0,o],xpos[1], ypos[1,o]], $ 
/NoErase
outplot, tmgw[153:*], mgwdata[3, i, 153:*]*A_sqk, color = col
;loadct,34
;vert_line,sec,1, color = 2
loadct,0
...
ytitl = power
linecolors
utplot, thmi[41:74], hmidata[3, i, 41:74]*A_sqk, $
/nodata, $
timerange = '29-Mar-14 '+['17:30:00','17:53:00'], $
linestyle = 0, $
ycharsize = 0.70 , $
...
position = [xpos[0],ypos[0,o],xpos[1], ypos[1,o]], $
/NoErase
outplot, thmi[41:74], hmidata[3, i, 41:74]*A_sqk, color = col
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
xyouts, xyx, xyy*1.01, charsize = 0.5, 'HMI Continuum Coord: '+ii, /norm
device,/close
set_plot,'x'
