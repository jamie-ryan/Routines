...
for i = 0, n_elements(sicoords1[0,*]) - 1 do begin
    ...
    tmp = map1400.data[sidata[0, 0, i, 0], sidata[0, 1, i, 0]]
    iris_radiometric_calibration, tmp, wave = 1400., n_pixels = 1, f, e, /sji
    sidata[0, 2, i, *] = f
    sidata[0, 3, i, *] = e
    tmp = map1400.data[sidata[1, 0, i, 0], sidata[1, 1, i, 0]]
    iris_radiometric_calibration, tmp, wave = 1400., n_pixels = 1, f, e, /sji
    sidata[1, 2, i, *] = f
    sidata[1, 3, i, *] = e
    ...
    tmp = submg.data[mgdata[0, 0, i, 0], mgdata[0, 1, i, 0]]
    iris_radiometric_calibration, tmp, wave = 2796., n_pixels = 1, f, e, /sji
    mgdata[0, 2, i, *] = f
    mgdata[0, 3, i, *] = e
    tmp = submg.data[mgdata[1, 0, i, 0], mgdata[1, 1, i, 0]]
    iris_radiometric_calibration, tmp, wave = 2796., n_pixels = 1, f, e, /sji
    mgdata[1, 2, i, *] = f
    mgdata[1, 3, i, *] = e 
    ...
    com = 'tmp[j] = total(sp2826.'+tagarr[j]+'.int[39:44, qkslitp[j], qkspyp[j]])/((44-39)*2)' 
    exe = execute(com)
    endfor
...
tmp = diff2832.data[mgwdata[0, 0, npt-1, 0], mgwdata[0, 1, i, 0]]
iris_radiometric_calibration, tmp, wave = 2832., n_pixels = 1, f, e, /sji
mgwdata[0, 2, npt-1, *] = f
mgwdata[0, 3, npt-1, *] = e
tmp = diff2832.data[mgwdata[1, 0, npt-1, 0], mgwdata[1, 1, i, 0]]
iris_radiometric_calibration, tmp, wave = 2832., n_pixels = 1, f, e, /sji
mgwdata[1, 2, npt-1, *] = f
mgwdata[1, 3, npt-1, *] = e
