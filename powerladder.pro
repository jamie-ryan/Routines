...
for i = 0, n_elements(sidata[3, *, 458]) - 1 do begin
outplot, tsi[458:*], sidata[3, i, 458:*]*A_sqk, color = col + i, linestyle = i
endfor
;loadct,3
...
/NoErase
for i = 0, n_elements(sidata[3, *, 458]) - 1 do begin
outplot, tmg[611:*], mgdata[3, i, 611:*]*A_sqk, color = col + i, linestyle = i
endfor
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
...
/NoErase
for i = 0, n_elements(sidata[3, *, 458]) - 1 do begin
outplot, times[i, 10:*], balmerdata[3, i, 10:*]*A_sqk, color = col + i, linestyle = i
endfor
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
...
/NoErase
for i = 0, n_elements(sidata[3, *, 458]) - 1 do begin
outplot, tmgw[153:*], mgwdata[3, 0, 153:*]*A_sqk, color = col + i, linestyle = i
endfor
;loadct,34
;vert_line,sec,1, color = 2
loadct,0
...
/NoErase
for i = 0, n_elements(sidata[3, *, 458]) - 1 do begin
outplot, thmi[41:74], hmidata[3, i, 41:74]*A_sqk, color = col + i, linestyle = i
endfor
;loadct,3
;vert_line,sec,1, color = 2
loadct,0
